...
class IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity(self._client, opts)
    ...
    def data_get(self) -> IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo:
    ...
    def match_get(self) -> IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
