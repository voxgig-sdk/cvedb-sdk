...
from cvedb_sdk.cvedb_types import (
...
class ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity(self._client, opts)
    ...
    def data_get(self) -> ThisEndpointIsTailoredForSearchesBasedOnProductNameOr:
    ...
    def match_get(self) -> ThisEndpointIsTailoredForSearchesBasedOnProductNameOr:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ThisEndpointIsTailoredForSearchesBasedOnProductNameOr:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ThisEndpointIsTailoredForSearchesBasedOnProductNameOr().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
