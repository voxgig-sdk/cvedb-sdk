...
from cvedb_sdk.utility import register

# Load features
from cvedb_sdk.feature.base_feature import CvedbBaseFeature
from cvedb_sdk.features import _has_feature, _make_feature
...
class CvedbSDK:
    ...
    def get_utility(self):
        return CvedbUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CvedbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cve(self, data=None) -> "CveEntity":
        ...
        from cvedb_sdk.entity.cve_entity import CveEntity
    ...
    def IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo(self, data=None) -> "IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity":
        ...
        from cvedb_sdk.entity.if_you_have_the_name_of_a_specific_software_product_and_want_to_entity import IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity
    ...
    def ThisEndpointIsTailoredForSearchesBasedOnProductNameOr(self, data=None) -> "ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity":
        ...
        from cvedb_sdk.entity.this_endpoint_is_tailored_for_searches_based_on_product_name_or_entity import ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity
