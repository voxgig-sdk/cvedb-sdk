...
from cvedb_sdk.core.helpers import get_ctx_prop, to_map
...
class CvedbContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CvedbResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CvedbError(code, msg, self)
