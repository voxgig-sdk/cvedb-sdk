...
from cvedb_sdk.core.response import CvedbResponse
from cvedb_sdk.core.operation import CvedbOperation
from cvedb_sdk.core.error import CvedbError
from cvedb_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CvedbSDK.test(None, None)
        ...
        class TestInitFeature(CvedbBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CvedbBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CvedbSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CvedbSDK.test(None, setup_opts)
