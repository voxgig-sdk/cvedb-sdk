# Cvedb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CvedbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CvedbSDK(...) and CvedbSDK.test(...) become
#      CvedbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    "Cve": "cve",
    "IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo": "if_you_have_the_name_of_a_specific_software_product_and_want_to",
    "ThisEndpointIsTailoredForSearchesBasedOnProductNameOr": "this_endpoint_is_tailored_for_searches_based_on_product_name_or",
}
