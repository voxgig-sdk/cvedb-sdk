...
(0, node_test_1.describe)('IfYouHaveTheNameOfASpecificSoftwareProductAndWantToDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-if_you_have_the_name_of_a_specific_software_product_and_want_to', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-if_you_have_the_name_of_a_specific_software_product_and_want_to', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CVEDB_TEST_IF_YOU_HAVE_THE_NAME_OF_A_SPECIFIC_SOFTWARE_PRODUCT_AND_WANT_TO_ENTID'];
...
//# sourceMappingURL=IfYouHaveTheNameOfASpecificSoftwareProductAndWantToDirect.test.js.map