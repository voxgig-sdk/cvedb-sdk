...
(0, node_test_1.describe)('IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'if_you_have_the_name_of_a_specific_software_product_and_want_to.' + op, live))
                return;
        }
        ...
        let if_you_have_the_name_of_a_specific_software_product_and_want_to_ref01_data = Object.values(setup.data.existing.if_you_have_the_name_of_a_specific_software_product_and_want_to)[0];
        // LOAD
        ...
        const if_you_have_the_name_of_a_specific_software_product_and_want_to_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != if_you_have_the_name_of_a_specific_software_product_and_want_to_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/if_you_have_the_name_of_a_specific_software_product_and_want_to/IfYouHaveTheNameOfASpecificSoftwareProductAndWantToTestData.json');
    ...
    let idmap = transform(['if_you_have_the_name_of_a_specific_software_product_and_want_to01', 'if_you_have_the_name_of_a_specific_software_product_and_want_to02', 'if_you_have_the_name_of_a_specific_software_product_and_want_to03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity.test.js.map