...
(0, node_test_1.describe)('CveDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-cve', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cve', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CVEDB_TEST_CVE_ENTID'];
...
//# sourceMappingURL=CveDirect.test.js.map