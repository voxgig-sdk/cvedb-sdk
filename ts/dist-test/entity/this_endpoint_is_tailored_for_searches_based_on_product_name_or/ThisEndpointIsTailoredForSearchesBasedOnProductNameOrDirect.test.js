...
(0, node_test_1.describe)('ThisEndpointIsTailoredForSearchesBasedOnProductNameOrDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-this_endpoint_is_tailored_for_searches_based_on_product_name_or', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-this_endpoint_is_tailored_for_searches_based_on_product_name_or', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CVEDB_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CvedbSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CVEDB_TEST_THIS_ENDPOINT_IS_TAILORED_FOR_SEARCHES_BASED_ON_PRODUCT_NAME_OR_ENTID'];
...
//# sourceMappingURL=ThisEndpointIsTailoredForSearchesBasedOnProductNameOrDirect.test.js.map