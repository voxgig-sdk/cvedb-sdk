...
class IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity extends CvedbEntityBase<IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo> {
  ...
  async load(this: any, reqmatch?: IfYouHaveTheNameOfASpecificSoftwareProductAndWantToLoadMatch, ctrl?: Control): Promise<IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity> {
