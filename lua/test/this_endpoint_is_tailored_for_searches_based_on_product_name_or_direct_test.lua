...
describe("ThisEndpointIsTailoredForSearchesBasedOnProductNameOrDirect", function()
  it("should direct-load-this_endpoint_is_tailored_for_searches_based_on_product_name_or", function()
    local setup = this_endpoint_is_tailored_for_searches_based_on_product_name_or_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-this_endpoint_is_tailored_for_searches_based_on_product_name_or", setup.live and "live" or "unit")
...
function this_endpoint_is_tailored_for_searches_based_on_product_name_or_direct_setup(mockres)
