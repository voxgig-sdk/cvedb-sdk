...
describe("CveDirect", function()
  it("should direct-load-cve", function()
    local setup = cve_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cve", setup.live and "live" or "unit")
...
function cve_direct_setup(mockres)
