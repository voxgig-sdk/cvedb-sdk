...
CvedbSDK._make_feature = _make_feature


function CvedbSDK.new(options)
  local self = setmetatable({}, CvedbSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CvedbSDK:get_utility()
  return Utility.copy(self._utility)
end


function CvedbSDK:get_root_ctx()
  return self._rootctx
end


function CvedbSDK:prepare(fetchargs)
...
function CvedbSDK:direct(fetchargs)
...
-- by passing it.
function CvedbSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CvedbSDK:graphql(query, variables, ctrl)
...
function CvedbSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CvedbSDK.new(sdkopts)
  sdk.mode = "test"
