-- Cvedb SDK IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity = {}
IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity.__index = IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity


function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity)
  self._name = "if_you_have_the_name_of_a_specific_software_product_and_want_to"
  self._client = client
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:get_name()
  return self._name
end


function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity.new(self._client, opts)
end
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:mark_deleted()
  self._deleted = true
end


function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:deleted()
  return true == self._deleted
end


function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:data_set(args)
  if args ~= nil then
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:match_set(args)
  if args ~= nil then
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:match_get()
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:stream(action, args, callopts)
...
---@param reqmatch IfYouHaveTheNameOfASpecificSoftwareProductAndWantToLoadMatch
---@param ctrl? table
---@return IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo
---@return string? err
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity
