-- Cvedb SDK ThisEndpointIsTailoredForSearchesBasedOnProductNameOr entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity = {}
ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity.__index = ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity


function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity)
  self._name = "this_endpoint_is_tailored_for_searches_based_on_product_name_or"
  self._client = client
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:get_name()
  return self._name
end


function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity.new(self._client, opts)
end
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:mark_deleted()
  self._deleted = true
end


function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:deleted()
  return true == self._deleted
end


function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:data_set(args)
  if args ~= nil then
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:match_set(args)
  if args ~= nil then
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:match_get()
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:stream(action, args, callopts)
...
function ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity
