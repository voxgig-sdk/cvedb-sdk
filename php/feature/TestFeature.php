...
// Cvedb SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CvedbTestFeature extends CvedbBaseFeature
{
    ...
    public function init(CvedbContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CvedbContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CvedbContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CvedbContext $ctx, $op, $args): array
    {
