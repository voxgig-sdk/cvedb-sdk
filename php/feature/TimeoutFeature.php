...
class CvedbTimeoutFeature extends CvedbBaseFeature
{
    ...
    private function _with_timeout(CvedbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CvedbContext $_ctx, float $ms): void
    {
        $client = $this->client;
