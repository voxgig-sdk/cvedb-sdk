...
class CvedbStreamingFeature extends CvedbBaseFeature
{
    ...
    private function _iterate(CvedbResult $result): \Generator
    {
    ...
    private function _streamable(CvedbContext $ctx): bool
    {
