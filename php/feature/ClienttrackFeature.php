...
class CvedbClienttrackFeature extends CvedbBaseFeature
{
    ...
    public function PostConstruct(CvedbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cvedb-SDK';
