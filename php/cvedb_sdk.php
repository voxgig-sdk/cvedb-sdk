...
class CvedbSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = CvedbHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = CvedbHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!CvedbFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, CvedbFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return CvedbUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = CvedbHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = CvedbHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = CvedbHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new CvedbError($op . "_allow",
                "CvedbSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = CvedbHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new CvedbError("graphql_error",
                "CvedbSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Cve($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_cve === null) {
                $this->_cve = new CveEntity($this, null);
            }
            return $this->_cve;
        }
        return new CveEntity($this, $data);
    }
    ...
    public function IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_if_you_have_the_name_of_a_specific_software_product_and_want_to === null) {
                $this->_if_you_have_the_name_of_a_specific_software_product_and_want_to = new IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity($this, null);
            }
            return $this->_if_you_have_the_name_of_a_specific_software_product_and_want_to;
        }
        return new IfYouHaveTheNameOfASpecificSoftwareProductAndWantToEntity($this, $data);
    }
    ...
    public function ThisEndpointIsTailoredForSearchesBasedOnProductNameOr($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_this_endpoint_is_tailored_for_searches_based_on_product_name_or === null) {
                $this->_this_endpoint_is_tailored_for_searches_based_on_product_name_or = new ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity($this, null);
            }
            return $this->_this_endpoint_is_tailored_for_searches_based_on_product_name_or;
        }
        return new ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity($this, $data);
    }
