...
class CveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CveEntity($this->_client, $opts);
    }

    /**
     * @param Cve|array $args Cve data (assoc-array) to store.
     */
    ...
    /**
     * @return Cve|array The current Cve data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cve fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cve fields).
     */
     ...
     * Load a single Cve.
     *
     * @param CveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cve|array The loaded Cve as an assoc-array at the
