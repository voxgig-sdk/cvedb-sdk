...
class CvedbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CvedbSDK/1.0)';
    ...
    public static function call(CvedbContext $ctx, string $fullurl, array $fetchdef): array
    {
