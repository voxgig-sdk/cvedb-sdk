...
// Cvedb SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CvedbMakeRequest
{
    public static function call(CvedbContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CvedbResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CvedbResponse($fetched);
        } else {
