...
The PHP SDK for the Cvedb API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Cve(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Cvedb(null)->load(
    ["id" => "test01"], null
);
