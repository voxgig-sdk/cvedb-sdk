...
class CvedbTestRunner
{
    ...
    {
        $live = self::getenv('CVEDB_TEST_LIVE');
        $override = self::getenv('CVEDB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CVEDB_TEST_EXPLAIN');
...
class_alias('CvedbTestRunner', 'Runner');
class_alias('CvedbHelpers', 'Helpers');
