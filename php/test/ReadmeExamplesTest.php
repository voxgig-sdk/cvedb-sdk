...
// Cvedb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CvedbSDK::test)
...
{
    private const SDK_CLASS = 'CvedbSDK';
    ...
    private const SDK_BASE = 'cvedb_sdk';
