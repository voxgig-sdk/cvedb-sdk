...
class ThisEndpointIsTailoredForSearchesBasedOnProductNameOrDirectTest extends TestCase
{
    public function test_direct_load_this_endpoint_is_tailored_for_searches_based_on_product_name_or(): void
    {
        $setup = this_endpoint_is_tailored_for_searches_based_on_product_name_or_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-this_endpoint_is_tailored_for_searches_based_on_product_name_or", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
