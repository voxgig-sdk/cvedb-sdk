...
class CveDirectTest extends TestCase
{
    public function test_direct_load_cve(): void
    {
        $setup = cve_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-cve", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
