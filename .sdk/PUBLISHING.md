...
|---|---|---|
| `ts/` | @voxgig-sdk/cvedb-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cvedb-sdk \
      --repository voxgig-sdk/cvedb-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cvedb-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cvedb-sdk --id=<id>` removes it.
