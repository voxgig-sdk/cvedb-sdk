...
class CvedbCacheFeature extends CvedbBaseFeature
{
    ...
    private function _through(CvedbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
