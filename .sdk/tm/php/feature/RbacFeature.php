...
class CvedbRbacFeature extends CvedbBaseFeature
{
    ...
    private function _required(CvedbContext $ctx): ?string
    {
    ...
    private function _reject(CvedbContext $ctx, string $required): void
    {
    ...
    private function _track(CvedbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
