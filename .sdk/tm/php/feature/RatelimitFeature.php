...
class CvedbRatelimitFeature extends CvedbBaseFeature
{
    ...
    private function _acquire(CvedbContext $ctx): void
    {
    ...
    private function _track(CvedbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
