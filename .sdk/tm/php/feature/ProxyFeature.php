...
class CvedbProxyFeature extends CvedbBaseFeature
{
    ...
    public function init(CvedbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CvedbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
