...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CvedbOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CvedbOmni::structfix($now, Struct::undef()))
                        !== json_encode(CvedbOmni::structfix($val, Struct::undef()))) {
