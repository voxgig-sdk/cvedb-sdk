...
const testSeed = `map[string]any{"entity": map[string]any{"cve": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "if_you_have_the_name_of_a_specific_software_product_and_want_to": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "this_endpoint_is_tailored_for_searches_based_on_product_name_or": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
