...
func (sdk *CvedbSDK) OptionsMap() map[string]any {
...
func (sdk *CvedbSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CvedbSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CvedbSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CvedbSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CvedbSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CvedbSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CvedbSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CvedbSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CvedbSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CvedbSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
