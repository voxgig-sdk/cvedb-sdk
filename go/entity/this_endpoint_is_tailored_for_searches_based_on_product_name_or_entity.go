...
type ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity struct {
	name    string
...
func NewThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity(client *core.CvedbSDK, entopts map[string]any) *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity{
...
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) GetName() string { return e.name }
...
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Deleted() bool {
	return e.deleted
}


func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity(e.client, opts)
}

func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Data(args ...any) any {
...
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
