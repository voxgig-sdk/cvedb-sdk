...
func NewCveEntity(client *core.CvedbSDK, entopts map[string]any) *CveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CveEntity) GetName() string { return e.name }
...
func (e *CveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CveEntity) Deleted() bool {
	return e.deleted
}


func (e *CveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCveEntity(e.client, opts)
}

func (e *CveEntity) Data(args ...any) any {
...
func (e *CveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cve; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CveEntity) DataTyped(data ...Cve) Cve {
	if len(data) > 0 {
		return typedFrom[Cve](e.Data(asMap(data[0])))
	}
	return typedFrom[Cve](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cve (all fields
// optional at the wire level).
func (e *CveEntity) MatchTyped(match ...Cve) Cve {
	if len(match) > 0 {
		return typedFrom[Cve](e.Match(asMap(match[0])))
	}
	return typedFrom[Cve](e.Match())
}
...
func (e *CveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CveEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CveLoadMatch and returns an Cve. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CveEntity) LoadTyped(reqmatch CveLoadMatch, ctrl map[string]any) (Cve, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cve{}, err
	}
	return typedFrom[Cve](res), nil
}



func (e *CveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
