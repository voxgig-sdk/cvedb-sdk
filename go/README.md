...
The Golang SDK for the Cvedb API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/cvedb-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/cvedb-sdk=../path/to/github.com/voxgig-sdk/cvedb-sdk
```
...
| `IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo` | `(data map[string]any) CvedbEntity` | Create a IfYouHaveTheNameOfASpecificSoftwareProductAndWantTo entity instance. |
...
```
github.com/voxgig-sdk/cvedb-sdk/
...
The root package (`github.com/voxgig-sdk/cvedb-sdk`) re-exports everything needed
