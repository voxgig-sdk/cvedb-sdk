...
class CveEntity
  ...
  # @return [Cve, Hash] the current Cve data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cve fields)
  def match_get
  ...
  # Load a single Cve.
  #
  # @param reqmatch [CveLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cve.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cve, Hash] the loaded Cve; raises CvedbError on failure
