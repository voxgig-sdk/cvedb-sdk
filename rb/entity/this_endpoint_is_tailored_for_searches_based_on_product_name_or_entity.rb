...
class ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "this_endpoint_is_tailored_for_searches_based_on_product_name_or"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ThisEndpointIsTailoredForSearchesBasedOnProductNameOrEntity.new(@_client, opts)
  end
  ...
  # @return [ThisEndpointIsTailoredForSearchesBasedOnProductNameOr, Hash] the current ThisEndpointIsTailoredForSearchesBasedOnProductNameOr data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ThisEndpointIsTailoredForSearchesBasedOnProductNameOr fields)
  def match_get
