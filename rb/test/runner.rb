...
module CvedbTestRunner
  ...
  def self.env_override(m)
    live = getenv("CVEDB_TEST_LIVE")
    override = getenv("CVEDB_TEST_OVERRIDE")
    ...
    explain = getenv("CVEDB_TEST_EXPLAIN")
    m["CVEDB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CvedbTestRunner
Helpers = CvedbHelpers
Vs = VoxgigStruct
